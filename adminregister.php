        ...
        <div class="form_section">
            ...
            <div class="form_controls">
                <div>
                    ...
                    <p>Get access to exclusive features by creating an account.
                    </p>
                    <small id="error"><?=isset($_GET['error']) ? $_GET['error']."Already exist": ' ' ?></small>
                    <form action="form_request/admin_register.php" name="registerForm" onsubmit="return validationForm()" method="POST">
                        ...
                        <div class="remember_me text-end">
                            <button class="btntheme" name="adminregisterBtn">Create account</button>
                        </div>
                    </form>
                    <div class="text-center">
                        Already have an account? <a href="admin.php">Sign in</a>
                    </div>
                </div>
            </div>
