        ...
        <div class="form_section">
            ...
            <div class="form_controls">
                <div>
                    ...
                    <form action="form_request/user_register.php" name="registerForm" onsubmit="return validationForm()" method="POST">
                        ...
                        <div class="remember_me text-end">
                            <button class="btntheme" name="registerBtn">Create account</button>
                        </div>
                    </form>
