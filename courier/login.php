...
<head>
    ...
    <title>Welcome to login - Courier management System</title>
    <!-- google fonts-->
        ...
        <div class="form_section">
            ...
            <div class="form_controls">
                <div>
                    ...
                    <form  action="form_request/user_login.php" name="loginform"  onsubmit="return validationForm()" method="POST">
                        ...
                        <div class="remember_me">
                            ...
                            <button class="btntheme" name="loginBtn">Login</button>
                        </div>
                    </form>
